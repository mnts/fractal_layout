...
class IconFPicker extends FormField<String> {
  ...
  IconFPicker({
    ...
    this.searchHint,
    this.iconCollection = MaterialFIcons.mIcons,
    FocusNode? focusNode,
...
class _IconPickerState extends FormFieldState<String> {
  ...
  @override
  IconFPicker get widget => super.widget as IconFPicker;
  ...
  @override
  void didUpdateWidget(IconFPicker oldWidget) {
